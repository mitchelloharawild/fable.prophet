# Getting help with fable.prophet

Thanks for using fable.prophet. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/fable.prophet/issues) to make sure the 
